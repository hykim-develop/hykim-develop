...
자동화 · 데이터 · AI — 경계 없이 배우고, 실무에 적용하는 개발자.

- 업무 자동화를 기반으로 데이터 엔지니어링까지 스택을 쌓는 것
- 데이터 흐름을 직접 설계하고, 병목을 찾아 최적화하는 것
- AI를 단순 도구가 아닌, 자동화 시스템의 핵심 엔진으로 엮는 것
- 기술 변화의 흐름을 읽고, 누구보다 빠르게 실무에 녹여내는 것
  
---

## 📫 Contact

* GitHub: hykim-develop
* Email: hykim-develop@gmail.com
